...
- The 25th percentile was calculated to be races with `r quantile(us_df$n_participants, 0.25)` participants.
- Since `r quantile(us_df$n_participants, 0.25)` is still small for a race size, it was determined that races with 85 or more participants would be analyzed as these races were sufficiently large enough while not eliminating too many data points.
